...
// ** Utils
import { hasActiveChild, removeChildren } from 'templates/utils'
...
import { MenuGroupToggleLeftIcon, MenuGroupToggleRightIcon, MenuItemTextWrapper } from './styles'
...
export const VerticalNavGroup = (props: VerticalNavGroupProps) => {
  // ** Props
  const {
    item,
    parent,
