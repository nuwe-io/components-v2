...
var ChevronLeft = require('mdi-material-ui/ChevronLeft');
var ChevronRight = require('mdi-material-ui/ChevronRight');
var react$1 = require('keen-slider/react');
var copy = require('clipboard-copy');
var createCache = require('@emotion/cache');
var dateFns = require('date-fns');
var Translate = require('mdi-material-ui/Translate');
var reactI18next = require('react-i18next');
var WeatherNight = require('mdi-material-ui/WeatherNight');
var WeatherSunny = require('mdi-material-ui/WeatherSunny');
var reactHotToast = require('react-hot-toast');
var ArrowUp = require('mdi-material-ui/ArrowUp');
var Link = require('next/link');
var router = require('next/router');
var reactPopper = require('react-popper');
var ChevronDown = require('mdi-material-ui/ChevronDown');
var PerfectScrollbar = require('react-perfect-scrollbar');
var CircleOutline$1 = require('mdi-material-ui/CircleOutline');
var Close = require('mdi-material-ui/Close');
var RecordCircleOutline = require('mdi-material-ui/RecordCircleOutline');
var AccountOutline = require('mdi-material-ui/AccountOutline');
var BugOutlined = require('mdi-material-ui/BugOutline');
var CogOutline = require('mdi-material-ui/CogOutline');
var EmailOutline = require('mdi-material-ui/EmailOutline');
var LogoutVariant = require('mdi-material-ui/LogoutVariant');
...
var WeatherNight__default = /*#__PURE__*/_interopDefaultLegacy(WeatherNight);
var WeatherSunny__default = /*#__PURE__*/_interopDefaultLegacy(WeatherSunny);
var ArrowUp__default = /*#__PURE__*/_interopDefaultLegacy(ArrowUp);
...
var CircleOutline__default$1 = /*#__PURE__*/_interopDefaultLegacy(CircleOutline$1);
var Close__default = /*#__PURE__*/_interopDefaultLegacy(Close);
var RecordCircleOutline__default = /*#__PURE__*/_interopDefaultLegacy(RecordCircleOutline);
var AccountOutline__default = /*#__PURE__*/_interopDefaultLegacy(AccountOutline);
var BugOutlined__default = /*#__PURE__*/_interopDefaultLegacy(BugOutlined);
var CogOutline__default = /*#__PURE__*/_interopDefaultLegacy(CogOutline);
var EmailOutline__default = /*#__PURE__*/_interopDefaultLegacy(EmailOutline);
var LogoutVariant__default = /*#__PURE__*/_interopDefaultLegacy(LogoutVariant);
...
function mergeSlotProps(parameters) {
  ...
  if (!getSlotProps) {
    ...
    const joinedClasses = clsx__default["default"](externalForwardedProps == null ? void 0 : externalForwardedProps.className, externalSlotProps == null ? void 0 : externalSlotProps.className, className, additionalProps == null ? void 0 : additionalProps.className);
  ...
  const joinedClasses = clsx__default["default"](internalSlotProps == null ? void 0 : internalSlotProps.className, additionalProps == null ? void 0 : additionalProps.className, className, externalForwardedProps == null ? void 0 : externalForwardedProps.className, externalSlotProps == null ? void 0 : externalSlotProps.className);
...
process.env.NODE_ENV !== "production" ? ClickAwayListener.propTypes /* remove-proptypes */ = {
   ...
   */
  onClickAway: PropTypes__default["default"].func.isRequired,
  /**
...
const Portal = /*#__PURE__*/React__namespace.forwardRef(function Portal(props, ref) {
  ...
  const handleRef = useForkRef( /*#__PURE__*/ /*#__PURE__*/React__namespace.isValidElement(children) ? children.ref : null, ref);
  useEnhancedEffect$1(() => {
    if (!disablePortal) {
...
process.env.NODE_ENV !== "production" ? Portal.propTypes /* remove-proptypes */ = {
   ...
   */
  container: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([HTMLElementType, PropTypes__default["default"].func]),
  /**
...
const Badge = /*#__PURE__*/React__namespace.forwardRef(function Badge(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(BadgeUnstyled$1, _extends({
    ...
    className: clsx__default["default"](rootSlotProps == null ? void 0 : rootSlotProps.className, classes.root, className),
    slotProps: {
      ...
      badge: _extends({}, badgeSlotProps, {
        className: clsx__default["default"](classes.badge, badgeSlotProps == null ? void 0 : badgeSlotProps.className)
...
const Card$1 = /*#__PURE__*/React__namespace.forwardRef(function Card(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiCard'
  });
...
process.env.NODE_ENV !== "production" ? Card$1.propTypes /* remove-proptypes */ = {
   ...
   * @default false
   */
  raised: chainPropTypes(PropTypes__default["default"].bool, props => {
...
const SwiperControls = ({
  ...
  // ** Hook
  const [sliderRef, instanceRef] = react$1.useKeenSlider({
    rtl: direction === 'rtl',
    slideChanged(slider) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(Box$1, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Box$1, {
        ...
        children: elements.map((element, i) => /*#__PURE__*/jsxRuntime.jsx(Card$2, {
          className: "keen-slider__slide",
          children: /*#__PURE__*/jsxRuntime.jsx(CardMedia$1, {
            sx: {
              height: mediaHeight
            },
            image: element
      ...
      }), loaded && instanceRef.current && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(ChevronLeft__default["default"], {
          className: clsx__default["default"]('arrow arrow-left', {
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(ChevronRight__default["default"], {
          className: clsx__default["default"]('arrow arrow-right', {
    ...
    }), loaded && instanceRef.current && /*#__PURE__*/jsxRuntime.jsx(Box$1, {
...
const SwiperFreeMode = ({
  ...
  // ** Hook
  const [ref] = react$1.useKeenSlider({
    loop: true,
    mode: 'free',
    rtl: direction === 'rtl',
    slides: {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
    ref: ref,
    className: "keen-slider",
    children: [/*#__PURE__*/jsxRuntime.jsx(Box$1, {
      className: "keen-slider__slide",
...
const Backdrop = /*#__PURE__*/React__namespace.forwardRef(function Backdrop(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends({
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(BackdropRoot, _extends({
      ...
      className: clsx__default["default"](classes.root, className, rootSlotProps == null ? void 0 : rootSlotProps.className),
  ...
  return /*#__PURE__*/jsxRuntime.jsx(PopoverRoot, _extends({
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends({
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(PopoverPaper, _extends({
        ...
        ref: handlePaperRef,
        className: clsx__default["default"](classes.paper, PaperProps.className)
...
process.env.NODE_ENV !== "production" ? Popover.propTypes /* remove-proptypes */ = {
   ...
   */
  anchorEl: chainPropTypes(PropTypes__default["default"].oneOfType([HTMLElementType, PropTypes__default["default"].func]), props => {
...
const Menu = /*#__PURE__*/React__namespace.forwardRef(function Menu(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(MenuRoot, _extends({
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(MenuMenuList, _extends({
      ...
      className: clsx__default["default"](classes.list, MenuListProps.className),
      children: children
    }))
  }));
});
process.env.NODE_ENV !== "production" ? Menu.propTypes /* remove-proptypes */ = {
   ...
   */
  anchorEl: PropTypes__default["default"] /* @typescript-to-proptypes-ignore */.oneOfType([HTMLElementType, PropTypes__default["default"].func]),
  /**
...
const MenuItem = /*#__PURE__*/React__namespace.forwardRef(function MenuItem(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ListContext$1.Provider, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(MenuItemRoot, _extends({
      ...
      tabIndex: tabIndex,
      component: component,
      focusVisibleClassName: clsx__default["default"](classes.focusVisible, focusVisibleClassName),
      className: clsx__default["default"](classes.root, className)
    }, other, {
      ownerState: ownerState,
      classes: classes
...
const LanguageDropdown = ({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(IconButton$1, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(Translate__default["default"], {})
    }), /*#__PURE__*/jsxRuntime.jsxs(Menu$1, {
      anchorEl: anchorEl,
...
const ModeToggler = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(IconButton$1, {
    ...
    children: settings.mode === 'dark' ? /*#__PURE__*/jsxRuntime.jsx(WeatherSunny__default["default"], {}) : /*#__PURE__*/jsxRuntime.jsx(WeatherNight__default["default"], {})
  });
};
...
const BlankLayout = ({
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(BlankLayoutWrapper, {
    ...
    children: [!hideNav && /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(LanguageDropdown, {
        settings: settings,
        saveSettings: saveSettings
      }), /*#__PURE__*/jsxRuntime.jsx(ModeToggler, {
        settings: settings,
        saveSettings: saveSettings
      })]
    }), /*#__PURE__*/jsxRuntime.jsx(Box$1, {
...
const AppBar$1 = /*#__PURE__*/React__namespace.forwardRef(function AppBar(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AppBarRoot, _extends({
    ...
    ownerState: ownerState,
    elevation: 4,
    className: clsx__default["default"](classes.root, className, position === 'fixed' && 'mui-fixed'),
    ref: ref
  }, other));
});
...
const Fab = /*#__PURE__*/React__namespace.forwardRef(function Fab(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(FabRoot, _extends({
    className: clsx__default["default"](classes.root, className),
    component: component,
    disabled: disabled,
    focusRipple: !disableFocusRipple,
...
const ScrollToTopSection = ({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ScrollToTop, {
    className: "mui-fixed",
    children: /*#__PURE__*/jsxRuntime.jsx(Fab$1, {
      color: "primary",
      size: "small",
      "aria-label": "scroll back to top",
      children: /*#__PURE__*/jsxRuntime.jsx(ArrowUp__default["default"], {})
    })
  });
};
...
const Chip = /*#__PURE__*/React__namespace.forwardRef(function Chip(inProps, ref) {
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color,
    iconColor: /*#__PURE__*/ /*#__PURE__*/React__namespace.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  if (onDelete) {
    deleteIcon = deleteIconProp && /*#__PURE__*/React__namespace.isValidElement(deleteIconProp) ? /*#__PURE__*/React__namespace.cloneElement(deleteIconProp, {
      className: clsx__default["default"](deleteIconProp.props.className, classes.deleteIcon),
      onClick: handleDeleteIconClick
    }) : /*#__PURE__*/jsxRuntime.jsx(CancelIcon, {
      className: clsx__default["default"](classes.deleteIcon),
      onClick: handleDeleteIconClick
    });
  }
  let avatar = null;
  if (avatarProp && /*#__PURE__*/React__namespace.isValidElement(avatarProp)) {
    avatar = /*#__PURE__*/React__namespace.cloneElement(avatarProp, {
      className: clsx__default["default"](classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && /*#__PURE__*/React__namespace.isValidElement(iconProp)) {
    icon = /*#__PURE__*/React__namespace.cloneElement(iconProp, {
      className: clsx__default["default"](classes.icon, iconProp.props.className)
    });
  }
  if (process.env.NODE_ENV !== 'production') {
    if (avatar && icon) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ChipRoot, _extends({
    ...
    children: [avatar || icon, /*#__PURE__*/jsxRuntime.jsx(ChipLabel, {
      className: clsx__default["default"](classes.label),
      ownerState: ownerState,
      children: label
    }), deleteIcon]
  }));
 ...
 */
const ListItem$2 = /*#__PURE__*/React__namespace.forwardRef(function ListItem(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiListItem'
  });
  ...
  const componentProps = _extends({
    className: clsx__default["default"](classes.root, rootProps.className, className),
    disabled
  }, other);
  let Component = componentProp || 'li';
  if (button) {
    componentProps.component = componentProp || 'div';
    componentProps.focusVisibleClassName = clsx__default["default"](listItemClasses$1.focusVisible, focusVisibleClassName);
  ...
  if (hasSecondaryAction) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(ListContext$1.Provider, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(ListItemContainer, _extends({
        ...
        className: clsx__default["default"](classes.container, ContainerClassName),
        ref: handleRef,
        ownerState: ownerState
      }, ContainerProps, {
...
const UserIcon = props => {
  ...
  // @ts-ignore
  return /*#__PURE__*/jsxRuntime.jsx(IconTag, {
    ...iconProps,
    style: {
      ...styles
    }
...
const HorizontalNavGroup = props => {
  ...
  const currentURL = router$1.pathname;
  const {
    skin,
    direction
  } = settings;
  ...
  const ToggleIcon = direction === 'rtl' ? ChevronLeft__default["default"] : ChevronRight__default["default"];
  ...
  const AnimationWrapper = horizontalMenuAnimation ? Fade$1 : React.Fragment;
  ...
  return /*#__PURE__*/jsxRuntime.jsx(MainWrapper, {
    ...(WrapperCondition ? {
      onClickAway: handleGroupClose
    } : {
      onMouseLeave: handleGroupClose
    }),
    children: /*#__PURE__*/jsxRuntime.jsx(ChildWrapper, {
      children: /*#__PURE__*/jsxRuntime.jsxs(List$1, {
        component: "div",
        sx: {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(ListItem$1, {
          ...
          className: clsx__default["default"]('menu-group', {
          ...
          children: /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsxs(Box$1, {
              ...
              children: [/*#__PURE__*/jsxRuntime.jsx(ListItemIcon$1, {
                sx: {
                  color: 'text.primary',
                  mr: !hasParent ? 2 : 3
                },
              ...
              children: [item.badgeContent ? /*#__PURE__*/jsxRuntime.jsx(Chip$1, {
              ...
              }) : null, hasParent ? /*#__PURE__*/jsxRuntime.jsx(ToggleIcon, {
                sx: {
                  fontSize: '1.375rem',
                  color: 'text.primary'
                }
              }) : /*#__PURE__*/jsxRuntime.jsx(ChevronDown__default["default"], {
                sx: {
                  fontSize: '1.375rem',
                  color: 'text.primary'
                }
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(AnimationWrapper, {
          ...(horizontalMenuAnimation && {
            in: menuOpen,
            timeout: {
              exit: 300,
          ...
          children: /*#__PURE__*/jsxRuntime.jsx(Box$1, {
            ...
            children: /*#__PURE__*/jsxRuntime.jsx(NavigationMenu, {
              sx: {
                ...(hasParent ? {
                  overflowY: 'auto',
                  overflowX: 'visible',
              ...
              children: /*#__PURE__*/jsxRuntime.jsx(HorizontalNavItems, {
                ...props,
                hasParent: true,
...
const HorizontalNavLink = props => {
  ...
  const IconTag = item.icon ? item.icon : navSubItemIcon;
  const Wrapper = !hasParent ? List$1 : React.Fragment;
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(Link__default["default"], {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(ListItem, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
          ...
          }), item.badgeContent ? /*#__PURE__*/jsxRuntime.jsx(Chip$1, {
            label: item.badgeContent,
            color: item.badgeColor || 'primary',
            sx: {
              ml: 1.6,
...
const AppBarContent$2 = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Box$1, {
    ...
    children: [userHorizontalAppBarBranding ? userHorizontalAppBarBranding(props) : /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Link__default["default"], {
        href: "/",
        passHref: true,
...
const Toolbar$2 = /*#__PURE__*/React__namespace.forwardRef(function Toolbar(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: 'MuiToolbar'
  });
...
const HorizontalLayout = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(HorizontalLayoutWrapper, {
    className: "layout-wrapper",
    children: [/*#__PURE__*/jsxRuntime.jsx(MuiAppBar, {
      color: "default",
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(Box$1, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(Toolbar$1, {
          ...
          children: /*#__PURE__*/jsxRuntime.jsx(AppBarContent$2, {
            ...props,
            hidden: hidden,
            settings: settings,
            saveSettings: saveSettings
    ...
    }), /*#__PURE__*/jsxRuntime.jsx(ContentWrapper$1, {
      ...
      children: children
    }), /*#__PURE__*/jsxRuntime.jsx(DatePickerWrapper, {
      sx: {
        zIndex: 11
      },
      children: /*#__PURE__*/jsxRuntime.jsx(Box$1, {
    ...
    }), /*#__PURE__*/jsxRuntime.jsx(ScrollToTopSection, {
...
process.env.NODE_ENV !== "production" ? Slide.propTypes /* remove-proptypes */ = {
   ...
   */
  container: chainPropTypes(PropTypes__default["default"].oneOfType([HTMLElementType, PropTypes__default["default"].func]), props => {
    if (props.open) {
...
const Drawer$1 = /*#__PURE__*/React__namespace.forwardRef(function Drawer(inProps, ref) {
  ...
  if (variant === 'permanent') {
    return /*#__PURE__*/jsxRuntime.jsx(DrawerDockedRoot, _extends({
      className: clsx__default["default"](classes.root, classes.docked, className),
      ownerState: ownerState,
      ref: ref
    }, other, {
      children: drawer
  ...
  return /*#__PURE__*/jsxRuntime.jsx(DrawerRoot, _extends({
    ...
    className: clsx__default["default"](classes.root, classes.modal, className),
    open: open,
    ownerState: ownerState,
    onClose: onClose,
...
const SwipeArea = /*#__PURE__*/React__namespace.forwardRef(function SwipeArea(props, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SwipeAreaRoot, _extends({
    className: clsx__default["default"]('PrivateSwipeArea-root', classes.root, classes[`anchor${capitalize(anchor)}`], className),
    ref: ref,
    style: _extends({
...
process.env.NODE_ENV !== "production" ? SwipeArea.propTypes = {
   ...
   */
  anchor: PropTypes__default["default"].oneOf(['left', 'top', 'right', 'bottom']).isRequired,
  /**
   * @ignore
   */
  classes: PropTypes__default["default"].object,
...
const SwipeableDrawer$1 = /*#__PURE__*/React__namespace.forwardRef(function SwipeableDrawer(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(Drawer$2, _extends({
      ...
      onClose: onClose,
      ref: ref
    }, other)), !disableSwipeToOpen && variant === 'temporary' && /*#__PURE__*/jsxRuntime.jsx(NoSsr, {
      children: /*#__PURE__*/jsxRuntime.jsx(SwipeArea$1, _extends({
        anchor: anchor,
        ref: swipeAreaRef,
...
const Drawer = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SwipeableDrawer, {
...
const VerticalNavHeader = props => {
  ...
  const MenuLockedIcon = () => userMenuLockedIcon || /*#__PURE__*/jsxRuntime.jsx(RecordCircleOutline__default["default"], {
    sx: {
      fontSize: '1.25rem',
      pointerEvents: 'none',
      ...menuCollapsedStyles,
  ...
  const MenuUnlockedIcon = () => userMenuUnlockedIcon || /*#__PURE__*/jsxRuntime.jsx(CircleOutline__default$1["default"], {
    sx: {
      fontSize: '1.25rem',
      pointerEvents: 'none',
      ...menuCollapsedStyles,
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(MenuHeaderWrapper, {
    className: "nav-header",
    sx: {
      pl: menuHeaderPaddingLeft()
    },
    children: [userVerticalNavMenuBranding ? userVerticalNavMenuBranding(props) : /*#__PURE__*/jsxRuntime.jsx(Link__default["default"], {
      href: "/",
      passHref: true,
      children: /*#__PURE__*/jsxRuntime.jsxs(StyledLink, {
        ...
        }), /*#__PURE__*/jsxRuntime.jsx(HeaderTitle, {
          variant: "h6",
          sx: {
            ...menuCollapsedStyles,
    ...
    }), hidden ? /*#__PURE__*/jsxRuntime.jsx(IconButton$1, {
      disableRipple: true,
    ...
    }) : /*#__PURE__*/jsxRuntime.jsx(IconButton$1, {
      disableRipple: true,
      disableFocusRipple: true,
...
const MenuGroupToggleRightIcon = styled$1(ChevronRight__default["default"])(({
  theme
}) => ({
  color: theme.palette.text.primary,
  transition: 'transform .25s ease-in-out'
}));
const MenuGroupToggleLeftIcon = styled$1(ChevronLeft__default["default"])(({
  theme
}) => ({
  color: theme.palette.text.primary,
  transition: 'transform .25s ease-in-out'
...
const VerticalNavGroup = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(React.Fragment, {
    children: /*#__PURE__*/jsxRuntime.jsxs(ListItem$3, {
      disablePadding: true,
      className: "nav-group",
      ...
      children: [/*#__PURE__*/jsxRuntime.jsxs(ListItemButton$1, {
        className: clsx__default["default"]({
        ...
        children: [isSubToSub ? null : /*#__PURE__*/jsxRuntime.jsx(ListItemIcon$1, {
          sx: {
            color: 'text.primary',
        ...
        }), /*#__PURE__*/jsxRuntime.jsxs(MenuItemTextWrapper, {
          sx: {
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(Typography$1, {
            ...
            }) : null, direction === 'ltr' ? /*#__PURE__*/jsxRuntime.jsx(MenuGroupToggleRightIcon, {
              sx: {
                ...conditionalColor(),
            ...
            }) : /*#__PURE__*/jsxRuntime.jsx(MenuGroupToggleLeftIcon, {
              sx: {
                ...conditionalColor(),
                ...(groupActive.includes(item.title) ? {
                  transform: 'rotate(-90deg)'
      ...
      }), /*#__PURE__*/jsxRuntime.jsx(Collapse$1, {
        component: "ul",
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(VerticalNavItems, {
          ...props,
          parent: item,
...
const VerticalNavLink = ({
  ...
  const isNavLinkActive = () => {
    if (router$1.pathname === item.path || handleURLQueries(router$1, item.path)) {
      return true;
    } else {
      return false;
    }
  };
  return /*#__PURE__*/jsxRuntime.jsx(ListItem$3, {
    disablePadding: true,
    className: "nav-link",
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(Link__default["default"], {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(MenuNavLink, {
        component: 'a',
        ...
        }), /*#__PURE__*/jsxRuntime.jsxs(MenuItemTextMetaWrapper, {
          sx: {
            ...(isSubToSub ? {
              ml: 9
            } : {}),
...
const ListSubheader$1 = /*#__PURE__*/React__namespace.forwardRef(function ListSubheader(inProps, ref) {
  ...
  const classes = useUtilityClasses$i(ownerState);
  return /*#__PURE__*/jsxRuntime.jsx(ListSubheaderRoot, _extends({
    as: component,
    className: clsx__default["default"](classes.root, className),
    ref: ref,
    ownerState: ownerState
...
// ** MUI Imports
const ListSubheader = styled$1(props => /*#__PURE__*/jsxRuntime.jsx(MuiListSubheader, {
  component: "li",
  ...props
}))(({
  theme
...
const VerticalNavSectionTitle = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ListSubheader, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(Divider$1, {
      ...
      children: navCollapsed && !navHover ? null : /*#__PURE__*/jsxRuntime.jsx(TypographyHeaderText, {
        noWrap: true,
...
const Navigation = props => {
  ...
  const [currentActiveGroup, setCurrentActiveGroup] = React.useState([]);
  ...
  const ScrollWrapper = hidden ? Box$1 : PerfectScrollbar__default["default"];
  return /*#__PURE__*/jsxRuntime.jsxs(Drawer, {
    ...props,
    children: [/*#__PURE__*/jsxRuntime.jsx(VerticalNavHeader, {
      ...props
    }), beforeVerticalNavMenuContent && beforeVerticalNavMenuContentPosition === 'fixed' ? beforeVerticalNavMenuContent(props) : null, (beforeVerticalNavMenuContentPosition === 'static' || !beforeVerticalNavMenuContent) && /*#__PURE__*/jsxRuntime.jsx(StyledBoxForShadow, {
      ref: shadowRef,
      sx: {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs(ScrollWrapper, {
        ...(hidden ? {
        ...
        children: [beforeVerticalNavMenuContent && beforeVerticalNavMenuContentPosition === 'static' ? beforeVerticalNavMenuContent(props) : null, userVerticalNavMenuContent ? userVerticalNavMenuContent(props) : /*#__PURE__*/jsxRuntime.jsx(List$1, {
          className: "nav-items",
          sx: {
            pt: 0,
...
const VerticalLayout = props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(VerticalLayoutWrapper, {
      className: "layout-wrapper",
      children: [navHidden && themeConfig.layout === 'vertical' && !(navHidden && settings.lastLayout === 'horizontal') ? null : /*#__PURE__*/jsxRuntime.jsx(Navigation, {
        navWidth: navWidth,
        navHover: navHover,
        navVisible: navVisible,
        ...
        ...props
      }), /*#__PURE__*/jsxRuntime.jsxs(MainContentWrapper, {
        className: "layout-content-wrapper",
        children: [/*#__PURE__*/jsxRuntime.jsx(LayoutAppBar, {
          toggleNavVisibility: toggleNavVisibility,
          ...props
        }), /*#__PURE__*/jsxRuntime.jsx(ContentWrapper, {
          className: "layout-page-content",
          sx: {
            ...(contentWidth === 'boxed' && {
              mx: 'auto',
...
const Layout = props => {
  ...
  if (settings.layout === 'horizontal') {
    return /*#__PURE__*/jsxRuntime.jsxs(HorizontalLayout, {
      ...props,
      children: [/*#__PURE__*/jsxRuntime.jsx(reactHotToast.Toaster, {
        position: "top-right",
        toastOptions: {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(VerticalLayout, {
    ...props,
    children: [/*#__PURE__*/jsxRuntime.jsx(reactHotToast.Toaster, {
...
const Button = /*#__PURE__*/React__namespace.forwardRef(function Button(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ButtonRoot, _extends({
    ownerState: ownerState,
    className: clsx__default["default"](contextProps.className, classes.root, className),
    component: component,
    disabled: disabled,
    focusRipple: !disableFocusRipple,
    focusVisibleClassName: clsx__default["default"](classes.focusVisible, focusVisibleClassName),
...
const LoadingButton = /*#__PURE__*/React__namespace.forwardRef(function LoadingButton(inProps, ref) {
  ...
  const loadingIndicator = loadingIndicatorProp != null ? loadingIndicatorProp : /*#__PURE__*/jsxRuntime.jsx(CircularProgress$1, {
    "aria-labelledby": id,
    color: "inherit",
    size: 16
  });
  ...
  const classes = useUtilityClasses$f(ownerState);
  const loadingButtonLoadingIndicator = loading ? /*#__PURE__*/jsxRuntime.jsx(LoadingButtonLoadingIndicator, {
    className: classes.loadingIndicator,
    ownerState: ownerState,
    children: loadingIndicator
  }) : null;
  return /*#__PURE__*/jsxRuntime.jsxs(LoadingButtonRoot, _extends({
...
process.env.NODE_ENV !== "production" ? LoadingButton.propTypes /* remove-proptypes */ = {
   ...
   * @default 'center'
   */
  loadingPosition: chainPropTypes(PropTypes__default["default"].oneOf(['start', 'end', 'center']), props => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(DialogRoot, _extends({
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends({
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(DialogContainer, {
        className: clsx__default["default"](classes.container),
        onMouseDown: handleMouseDown,
        ownerState: ownerState,
    ...
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, /*#__PURE__*/jsxRuntime.jsxs(Root, _extends({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, /*#__PURE__*/jsxRuntime.jsx(FormControlContext$1.Provider, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(Input, _extends({
          ...
          ref: handleInputRef,
          className: clsx__default["default"](classes.input, inputProps.className),
          onBlur: handleBlur,
          onChange: handleChange,
          onFocus: handleFocus
        }))
...
process.env.NODE_ENV !== "production" ? InputLabel.propTypes /* remove-proptypes */ = {
   ...
   * @default 'normal'
   */
  size: PropTypes__default["default"].oneOf(['normal', 'small']),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
  sx: PropTypes__default["default"].oneOfType([PropTypes__default["default"].arrayOf(PropTypes__default["default"].oneOfType([PropTypes__default["default"].func, PropTypes__default["default"].object, PropTypes__default["default"].bool])), PropTypes__default["default"].func, PropTypes__default["default"].object]),
...
const NativeSelectInput = /*#__PURE__*/React__namespace.forwardRef(function NativeSelectInput(props, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(NativeSelectSelect, _extends({
      ownerState: ownerState,
      className: clsx__default["default"](classes.select, className),
      disabled: disabled,
      ref: inputRef || ref
...
const SelectInput = /*#__PURE__*/React__namespace.forwardRef(function SelectInput(props, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(SelectSelect, _extends({
      ...
      ownerState: ownerState,
      className: clsx__default["default"](SelectDisplayProps.className, classes.select, className)
...
const Select = /*#__PURE__*/React__namespace.forwardRef(function Select(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(React__namespace.Fragment, {
    children: /*#__PURE__*/React__namespace.cloneElement(InputComponent, _extends({
      ...
      className: clsx__default["default"](InputComponent.props.className, className)
    }, !input && {
      variant
    }, other))
  });
...
const DialogContact = ({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(Dialog$1, {
    ...
    children: /*#__PURE__*/jsxRuntime.jsxs(DialogContent$1, {
      sx: {
        pb: 8,
        px: {
          xs: 8,
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(IconButton$1, {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsxs(Grid$1, {
          container: true,
          spacing: 6,
          children: [/*#__PURE__*/jsxRuntime.jsxs(Grid$1, {
            item: true,
            sm: 6,
            xs: 12,
            children: [(errors === null || errors === void 0 ? void 0 : (_errors$email = errors.email) === null || _errors$email === void 0 ? void 0 : _errors$email.message) && /*#__PURE__*/jsxRuntime.jsx(Typography$1, {
              style: {
                margin: '3px 0px'
              },
              variant: "body2",
          ...
          }), /*#__PURE__*/jsxRuntime.jsxs(Grid$1, {
            item: true,
            sm: 6,
            xs: 12,
            children: [(errors === null || errors === void 0 ? void 0 : (_errors$name = errors.name) === null || _errors$name === void 0 ? void 0 : _errors$name.message) && /*#__PURE__*/jsxRuntime.jsx(Typography$1, {
              style: {
                margin: '3px 0px'
              },
              variant: "body2",
            ...
            item: true,
            xs: 12,
            children: [(errors === null || errors === void 0 ? void 0 : (_errors$message = errors.message) === null || _errors$message === void 0 ? void 0 : _errors$message.message) && /*#__PURE__*/jsxRuntime.jsx(Typography$1, {
              style: {
                margin: '3px 0px'
              },
              variant: "body2",
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx(LoadingButton$1, {
            loading: isLoading,
            variant: "contained",
            type: "submit",
            sx: {
          ...
          }), /*#__PURE__*/jsxRuntime.jsx(LoadingButton$1, {
            variant: "outlined",
            color: "error",
            onClick: () => setShow(false),
...
DialogContact.propTypes = {
  ...
  onSubmitAction: PropTypes__default["default"].func,
  texts: PropTypes__default["default"].object
};
...
const UserDropdown = props => {
  ...
  const menuItems = [{
    title: texts.profile,
    Icon: AccountOutline__default["default"],
    onClick: goToProfile
  }, {
    title: texts.settings,
    Icon: CogOutline__default["default"],
    onClick: goToSettings
  }, {
    title: texts.contact,
    Icon: EmailOutline__default["default"],
    onClick: handleContact
  }, {
    title: texts.feedback,
    Icon: BugOutlined__default["default"],
    onClick: () => handleDropdownCloseNewWindows('https://forms.clickup.com/20463730/f/kgg3j-18865/EADM21P4CELDYPQW7E')
  }, {
    title: texts.logout,
    Icon: LogoutVariant__default["default"],
    onClick: handleLogout
  }];
  return /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(Badge$1, {
      overlap: "circular",
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(Avatar$1, {
        alt: "John Doe",
        onClick: handleDropdownOpen,
        sx: {
          width: 40,
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Box$1, {
      ...
      }), /*#__PURE__*/jsxRuntime.jsx(Divider$1, {
        sx: {
          mt: 0,
          mb: 1
        }
        ...
        title,
        onClick
      }, index) => /*#__PURE__*/jsxRuntime.jsx(CustomMenuIcon, {
        title: title,
        onClick: onClick,
    ...
    }), /*#__PURE__*/jsxRuntime.jsx(DialogContact, {
      feedBack: feedBack,
      show: show,
      setShow: setShow
    })]
...
UserDropdown.propTypes = {
  ...
  goToSettings: PropTypes__default["default"].func,
  goToProfile: PropTypes__default["default"].func,
  feedBack: PropTypes__default["default"].func,
  texts: PropTypes__default["default"].shape({
    profile: PropTypes__default["default"].string,
    settings: PropTypes__default["default"].string,
    contact: PropTypes__default["default"].string,
    feedback: PropTypes__default["default"].string,
    logout: PropTypes__default["default"].string
  })
};
  ...
  const render = {
    ...
    authorized: /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(LanguageDropdown, {
        ...
        settings: settings,
        saveSettings: saveSettings
      }), /*#__PURE__*/jsxRuntime.jsx(UserDropdown, {
        logout: logout,
        user: user,
        settings: settings
      })]
  ...
  const render = {
    ...
    authorized: /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsxs(Box$1, {
        ...
        }) : null, /*#__PURE__*/jsxRuntime.jsx(ModeToggler, {
          settings: settings,
          saveSettings: saveSettings
        }), /*#__PURE__*/jsxRuntime.jsx(LanguageDropdown, {
          settings: settings,
          saveSettings: saveSettings
        })]
      }), /*#__PURE__*/jsxRuntime.jsx(Box$1, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(UserDropdown, {
          user: user,
          settings: settings,
          logout: logout
        })
...
exports.SwiperControls = SwiperControls;
exports.SwiperFreeMode = SwiperFreeMode;
exports.ThemeComponent = ThemeComponent;
exports.ThemeComponentService = ThemeComponentService;
exports.Typography = Typography$2;
exports.UseBgColor = UseBgColor;
exports.UserLayout = UserLayout;
exports.UserThemeOptions = UserThemeOptions;
