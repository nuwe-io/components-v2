...
import { useTheme as useTheme$4, Box as Box$2, Typography as Typography$2 } from '@mui/material';
...
import React__default, { Children, isValidElement, cloneElement, createContext, useState, useEffect, useRef, useCallback, useContext, Fragment } from 'react';
import ReactDOM from 'react-dom';
import clsx from 'clsx';
import themeConfig$1 from 'configs/themeConfig';
import copy from 'clipboard-copy';
import { useSettings as useSettings$1 } from 'core/hooks/useSettings';
import { hexToRGBA as hexToRGBA$1 } from 'core/utils/hex-to-rgba';
...
const initialSettings = {
  themeColor: 'primary',
  mode: themeConfig$1.mode,
  footer: themeConfig$1.footer,
  layout: themeConfig$1.layout,
  lastLayout: themeConfig$1.layout,
  direction: themeConfig$1.direction,
  navHidden: themeConfig$1.navHidden,
  appBarBlur: themeConfig$1.appBarBlur,
  navCollapsed: themeConfig$1.navCollapsed,
  contentWidth: themeConfig$1.contentWidth,
  toastPosition: themeConfig$1.toastPosition,
  verticalNavToggleType: themeConfig$1.verticalNavToggleType,
  skin: themeConfig$1.layout === 'horizontal' && themeConfig$1.skin === 'semi-dark' ? 'default' : themeConfig$1.skin,
  appBar: themeConfig$1.layout === 'horizontal' && themeConfig$1.appBar === 'hidden' ? 'fixed' : themeConfig$1.appBar
};
...
const StepperWrapper = styled$1(Box$1)(({
  ...
  '& .MuiStepConnector-root': {
    ...
    '&.Mui-disabled .MuiStepConnector-line': {
      borderColor: hexToRGBA$1(theme.palette.primary.main, 0.12)
    }
  },
...
const GlobalStyles$1 = (theme, settings) => {
  ...
  return {
    'body[style^="padding-right"] .layout-navbar-and-nav-container::after': {
      ...
      top: 0,
      height: '100%',
      backgroundColor: hexToRGBA$1(theme.palette.background.paper, 0.85),
      width: '30px'
    },
    '.demo-space-x > *': {
    ...
    MuiAlert: {
      styleOverrides: {
        ...
        standardSuccess: {
          ...
          backgroundColor: hexToRGBA$1(theme.palette.success.main, 0.12),
          '& .MuiAlertTitle-root': {
            color: getColor(theme.palette.success.main, 0.12)
          },
          '& .MuiAlert-icon': {
        ...
        standardInfo: {
          ...
          backgroundColor: hexToRGBA$1(theme.palette.info.main, 0.12),
          '& .MuiAlertTitle-root': {
            color: getColor(theme.palette.info.main, 0.12)
          },
          '& .MuiAlert-icon': {
        ...
        standardWarning: {
          ...
          backgroundColor: hexToRGBA$1(theme.palette.warning.main, 0.12),
          '& .MuiAlertTitle-root': {
            color: getColor(theme.palette.warning.main, 0.12)
          },
          '& .MuiAlert-icon': {
        ...
        standardError: {
          ...
          backgroundColor: hexToRGBA$1(theme.palette.error.main, 0.12),
          '& .MuiAlertTitle-root': {
            color: getColor(theme.palette.error.main, 0.12)
          },
          '& .MuiAlert-icon': {
...
const Backdrop = theme => {
  return {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: theme.palette.mode === 'light' ? `rgba(${theme.palette.customColors.main}, 0.7)` : hexToRGBA$1(theme.palette.background.default, 0.7)
        },
        invisible: {
...
const Button = theme => {
  return {
    ...
    MuiButtonBase: {
      defaultProps: {
        disableRipple: themeConfig$1.disableRipple
      }
    }
  };
};
      ...
      styleOverrides: {
        ...
        deletableColorPrimary: {
          '&.MuiChip-light .MuiChip-deleteIcon': {
            color: hexToRGBA$1(theme.palette.primary.main, 0.7),
            '&:hover': {
              color: theme.palette.primary.main
            }
          }
        ...
        deletableColorSecondary: {
          '&.MuiChip-light .MuiChip-deleteIcon': {
            color: hexToRGBA$1(theme.palette.secondary.main, 0.7),
            '&:hover': {
              color: theme.palette.secondary.main
            }
          }
        ...
        deletableColorSuccess: {
          '&.MuiChip-light .MuiChip-deleteIcon': {
            color: hexToRGBA$1(theme.palette.success.main, 0.7),
            '&:hover': {
              color: theme.palette.success.main
            }
          }
        ...
        deletableColorError: {
          '&.MuiChip-light .MuiChip-deleteIcon': {
            color: hexToRGBA$1(theme.palette.error.main, 0.7),
            '&:hover': {
              color: theme.palette.error.main
            }
          }
        ...
        deletableColorWarning: {
          '&.MuiChip-light .MuiChip-deleteIcon': {
            color: hexToRGBA$1(theme.palette.warning.main, 0.7),
            '&:hover': {
              color: theme.palette.warning.main
            }
          }
        ...
        deletableColorInfo: {
          '&.MuiChip-light .MuiChip-deleteIcon': {
            color: hexToRGBA$1(theme.palette.info.main, 0.7),
            '&:hover': {
              color: theme.palette.info.main
            }
          }
        ...
        root: {
          ...
          '& .PrivatePickersToolbar-root': {
            ...
            '& .PrivateTimePickerToolbar-hourMinuteLabel': {
              ...
              '& > .MuiTypography-root': {
                color: hexToRGBA$1(theme.palette.primary.contrastText, 0.54),
                '& + .MuiButton-root > span.MuiTypography-root': {
                  color: hexToRGBA$1(theme.palette.primary.contrastText, 0.54)
                }
              }
  ...
  return {
    MuiPaginationItem: {
      styleOverrides: {
        ...
        outlinedPrimary: {
          '&.Mui-selected': {
            backgroundColor: hexToRGBA$1(theme.palette.primary.main, 0.12),
            '&:hover': {
              backgroundColor: `${hexToRGBA$1(theme.palette.primary.main, 0.2)} !important`
            }
          }
        },
        outlinedSecondary: {
          '&.Mui-selected': {
            backgroundColor: hexToRGBA$1(theme.palette.secondary.main, 0.12),
            '&:hover': {
              backgroundColor: `${hexToRGBA$1(theme.palette.secondary.main, 0.2)} !important`
            }
          }
        }
      }
...
const Timeline = theme => {
  return {
    ...
    MuiTimelineDot: {
      styleOverrides: {
        filledPrimary: {
          boxShadow: `0 0 0 3px ${hexToRGBA$1(theme.palette.primary.main, 0.12)}`
        },
        filledSecondary: {
          boxShadow: `0 0 0 3px ${hexToRGBA$1(theme.palette.secondary.main, 0.12)}`
        },
        filledSuccess: {
          boxShadow: `0 0 0 3px ${hexToRGBA$1(theme.palette.success.main, 0.12)}`
        },
        filledError: {
          boxShadow: `0 0 0 3px ${hexToRGBA$1(theme.palette.error.main, 0.12)}`
        },
        filledWarning: {
          boxShadow: `0 0 0 3px ${hexToRGBA$1(theme.palette.warning.main, 0.12)}`
        },
        filledInfo: {
          boxShadow: `0 0 0 3px ${hexToRGBA$1(theme.palette.info.main, 0.12)}`
        },
        filledGrey: {
          boxShadow: `0 0 0 3px ${hexToRGBA$1(theme.palette.grey[400], 0.12)}`
        },
        outlinedPrimary: {
          '& svg': {
            color: theme.palette.primary.main
...
const Tooltip = theme => {
  return {
    MuiTooltip: {
      styleOverrides: {
        tooltip: {
          backgroundColor: theme.palette.mode === 'light' ? hexToRGBA$1(theme.palette.grey[900], 0.9) : hexToRGBA$1(theme.palette.grey[700], 0.9)
        },
        arrow: {
          color: theme.palette.mode === 'light' ? hexToRGBA$1(theme.palette.grey[900], 0.9) : hexToRGBA$1(theme.palette.grey[700], 0.9)
        }
      }
    }
  };
...
const ThemeComponent = props => {
  ...
  if (themeConfig$1.responsiveFontSizes) {
